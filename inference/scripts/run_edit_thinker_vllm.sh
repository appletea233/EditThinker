...
VLLM_IP=$2
export VLLM_BASE_URL="http://${VLLM_IP}:8000/v1"
export VLLM_API_KEY="EMPTY"
# Please replace with your own model and API endpoint
REWRITE_MODEL_NAME=/path/to/your/editthinker/model  # Replace with your EditThinker model path
...
MAX_EDIT_TURNS=5
NUM_WORKERS=128 
EVAL_PROMPT_FILE=./prompt_template.txt
...
RESULT_BASE_DIR=/path/to/your/results/${MODEL_NAME}/vllm/  # Replace with your result output directory
