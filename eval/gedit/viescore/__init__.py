...
from gedit.viescore.utils import (
    mllm_output_to_dict
)
import math
import gedit.viescore.vie_prompts as vie_prompts
...
class VIEScore:
    def __init__(self, backbone="gpt4o", task="t2i", key_path=None, azure_endpoint='') -> None:
        ...
        if self.backbone_name == "gpt4o":
            from gedit.viescore.mllm_tools.openai import GPT4o
            ...
            from gedit.viescore.mllm_tools.qwen25vl_eval import Qwen25VL
            self.model = Qwen25VL()
        else:
