...
from kris.metrics_common import (
...
def encode_image_to_base64(image_path):
    """Encode image to base64 string, with automatic compression if needed."""
    try:
...
def evaluate_images(model_name, category, image_id, metrics=None):
    ...
    edited_path = os.path.join(RESULTS_DIR, category, f"{image_id}.png")
