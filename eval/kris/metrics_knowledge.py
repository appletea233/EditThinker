...
def encode_image_to_base64(path):
    """Read an image file and return its base64-encoded string, with automatic compression if needed."""
    try:
        ...
        with open(path, "rb") as f:
            ...
            logging.info(f"Image {path} is {size_mb:.2f}MB, compressing...")
            return compress_image_if_needed(path, max_size_mb=3.0)
